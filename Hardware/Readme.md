...
<img src="assets/Brush.svg" width="600px" max-width="100%" alt="Photo of the Thermal Brush, consisting of a switch, lipo battery, microcontroller, circuit board with pull-up resistors, and a bend sensor. They are all mounted near the ferrule on the brush using a 3D-printed part." />
Here, we describe the hardware configuration of Thermal Brush, a brush that detects its stroke direction and the color being painted in real-time.<br>
...
This is the example for the Xiao board. If you use Arduino, please refer to [the documentation](https://docs.arduino.cc/learn/communication/wire/).
