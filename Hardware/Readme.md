...
<img src="assets/Brush.svg" width="400" alt="Photo of the Thermal Brush, consisting of a switch, lipo battery, microcontroller, circuit board with pull-up resistors, and a bend sensor. They are all mounted near the ferrule on the brush using a 3D-printed part." />
